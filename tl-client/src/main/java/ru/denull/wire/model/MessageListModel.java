...
import ru.denull.wire.stub.tl.TInputPeer;
import ru.denull.wire.stub.tl.TLObject;
import ru.denull.wire.stub.tl.TMessage;
import ru.denull.wire.stub.tl.messages.GetHistory;
import ru.denull.wire.stub.tl.messages.ReadHistory;
import ru.denull.wire.stub.tl.messages.TMessages;
...
//import ru.denull.wire.stub.tl.GetHistory;
//import ru.denull.wire.stub.tl.messages.Messages;
//import ru.denull.wire.stub.tl.messages.MessagesSlice;
...
public class MessageListModel extends AbstractListModel {
  ...
  public boolean isEnabled(int position) {
    ...
    private void load() {
        ...
        if (service.mainServer == null || !service.mainServer.transport.isConnected() || loading || peer == null)
            return;
        ...
        service.mainServer.call(new GetHistory(peer, 0, first_id, (first_id == 0) ? PRELOAD_COUNT : LOAD_COUNT), new RPCCallback<TMessages>() {
            public void done(final TMessages result) {
                ...
                if (result instanceof TMessages) {
